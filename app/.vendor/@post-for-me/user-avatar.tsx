...
import { AccountIcon as User } from "~/icons";
...
export function UserAvatar({
  ...
  return (
    <Avatar size={size} className={cn("after:border-input", className)} {...props}>
      ...
      <AvatarFallback
        ...
        className={cn(
          ...
          "bg-muted text-foreground font-medium uppercase [&_svg]:size-3/5",
...
const iconBadgeSizing = [
  "p-1 [&_svg]:size-3", // default (size-8 avatar)
