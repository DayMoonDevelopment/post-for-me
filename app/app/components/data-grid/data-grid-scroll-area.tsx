  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        {showHorizontal ? <ScrollAreaPrimitive.Scrollbar
          ...
          >
            ...
            />
          </ScrollAreaPrimitive.Scrollbar> : null}

        {showVertical && !usesCustomVerticalScrollbar ? <ScrollAreaPrimitive.Scrollbar
            data-slot="data-grid-scrollbar"
      ...
      {usesCustomVerticalScrollbar && hasCustomVerticalOverflow ? <div
          ref={setOverlayRef}
          aria-hidden="true"
