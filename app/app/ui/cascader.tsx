...
} from "~/ui/cascader-context"
import type { CascaderCheckedStrategy } from "~/ui/cascader-lib"
import type {
  CascaderActionItem,
...
import { resolveCascaderLabels } from "~/ui/cascader-i18n"
import {
...
const CHIPS_CLASS =
  "flex flex-wrap items-center border bg-clip-padding dark:bg-input/30 border-input focus-within:border-ring has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive dark:has-aria-invalid:border-destructive/50 rounded-md gap-1 transition-colors has-data-[slot=combobox-chip]:px-1 bg-input/20 focus-within:ring-ring/30 min-h-7 px-2 py-0.5 text-xs/relaxed focus-within:ring-2 has-aria-invalid:ring-2"

const CHIP_CLASS =
  "text-foreground flex w-fit items-center justify-center gap-1 font-medium whitespace-nowrap px-1.5 has-data-[slot=combobox-chip-remove]:pr-0 bg-muted-foreground/10 h-[calc(--spacing(4.75))] rounded-[calc(var(--radius-sm)-2px)] text-xs/relaxed"
...
const CONTENT_SURFACE_CLASS =
  "bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 overflow-hidden ring-1 duration-100 ring-foreground/10 shadow-md rounded-lg dark:bg-popover data-[side=inline-start]:slide-in-from-right-2 data-[side=inline-end]:slide-in-from-left-2"

const EMPTY_CLASS =
  "text-muted-foreground hidden w-full justify-center py-2 text-center group-data-empty/combobox-content:flex text-xs/relaxed"
