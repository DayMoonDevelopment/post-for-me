...
import { CommentIcon, DownloadIcon, PlayIcon, ShareIcon, ThumbDownIcon, ThumbUpIcon } from "~/icons";
...
function splitTitle(caption: string): { description: string; title: string; } {
      ...
      <div className="flex flex-1 flex-col bg-background">
        <div className="flex flex-col gap-[0.5em] p-[0.9em]">
          ...
          <div className="flex items-center gap-[1.1em] pt-[0.2em] text-muted-foreground [&_svg]:size-[1.2em]">
            ...
            <ThumbDownIcon aria-label={t("preview.actions.dislike")} />
            <ShareIcon aria-label={t("preview.actions.share")} />
            <DownloadIcon aria-label={t("preview.actions.download")} />
          </div>
          ...
          <div className="mt-[0.2em] flex items-center gap-[0.6em] border-t border-border pt-[0.7em]">
            {enriched ? (
              ...
              <>
                ...
                <Skeleton className="me-auto h-[0.85em] w-[7em] rounded-full" />
              </>
            )}
