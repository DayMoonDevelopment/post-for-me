...
import { AddIcon, BookmarkIcon, CommentIcon, HeartIcon, MusicIcon, ShareIcon } from "~/icons";
...
export function TikTokPostUI({
  ...
  return (
    <div className={cn("absolute inset-0 text-white", className)}>
      {/* right action rail */}
      <div className="absolute end-[0.7em] bottom-[3em] flex flex-col items-center gap-[1.1em]">
        ...
        <span className="relative mb-[0.3em]">
          ...
          <span className="absolute -bottom-[0.5em] start-1/2 grid size-[1.1em] -translate-x-1/2 rtl:translate-x-1/2 place-items-center rounded-full bg-[#fe2c55] text-white [&_svg]:size-[0.7em]">
            <AddIcon aria-hidden />
          </span>
        </span>
      ...
      {/* bottom-left meta */}
      <div className="absolute inset-x-0 bottom-0 space-y-[0.4em] p-[0.9em] pe-[3.4em] pb-[3em]">
        {enriched ? (
