import type { CascaderCollapse } from "~/ui/cascader-types"
import type {
  FilterField,
  FilterIndex,
  FilterOperator,
...
import { collapseCascaderPath } from "~/ui/cascader-lib"
...
export type FilterPathSegment<V = unknown, O = unknown> =
  | { field: FilterField<V, O>; type: "field"; }
  /** The run that was elided, kept so a host can surface it. */
  | { hidden: FilterField<V, O>[]; type: "ellipsis"; }
...
export function collapseFilterPath<V, O>(
  ...
  options: { collapse?: FilterPathCollapse; maxSegments?: number; } = {}
