...
import { ChartIcon, CommentIcon, HeartIcon, MoreIcon, PlayIcon, RepostIcon, ShareIcon } from "~/icons";
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-[0.5em]">
        ...
        <div className="flex items-center gap-[0.3em]">
          ...
          <MoreIcon className="ms-auto size-[1.2em] shrink-0 text-muted-foreground"
            aria-hidden />
        </div>
        ...
        <div className="mt-[0.3em] flex items-center justify-between text-muted-foreground [&_svg]:size-[1.15em]">
          ...
          <ChartIcon aria-label={t("preview.actions.views")} />
