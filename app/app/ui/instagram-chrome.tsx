...
import { BookmarkIcon, CloseIcon, CommentIcon, CopyIcon, HeartIcon, MoreIcon, MusicIcon, PlayIcon, RepostIcon, SendIcon, VerifiedIcon } from "~/icons";
    ...
    >
      ...
      <div className="flex items-center gap-[0.6em] p-[0.7em]">
        {enriched ? (
          <>
            ...
            <VerifiedIcon className="size-[1.1em] shrink-0 text-[#0095f6]"
      ...
      <div className="flex items-center gap-[0.7em] px-[0.7em] pt-[0.6em] text-foreground [&_svg]:size-[1.45em]">
        ...
        <CommentIcon className="-scale-x-100"
          aria-label={t("preview.actions.comment")} />
        <SendIcon aria-label={t("preview.actions.share")} />
        <BookmarkIcon className="ms-auto"
  ...
  return (
    <div className={className}>
      <div className="relative">
        <Carousel setApi={setApi} className="w-full">
          <CarouselContent className="ms-0">
            {media.map((item, index) => (
              <CarouselItem key={item.id} className="ps-0">
                <IgMediaFrame
                  item={item}
                  ratio={ratio}
        ...
        <span className="pointer-events-none absolute top-[0.6em] end-[0.6em] text-white drop-shadow [&_svg]:size-[1.2em]">
...
export function InstagramReelUI({
  ...
  return (
    <div className={cn("absolute inset-0 text-white", className)}>
      ...
      <div className="absolute end-[0.85em] bottom-[3em] z-10 flex flex-col items-center gap-[1.05em] drop-shadow [&_svg]:size-[1.6em]">
        <HeartIcon aria-label={t("preview.actions.like")} />
        <CommentIcon className="-scale-x-100"
          aria-label={t("preview.actions.comment")} />
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 space-y-[0.5em] p-[1em] pe-[3.2em] pb-[3em]">
        <div className="flex items-center gap-[0.5em]">
          ...
          {enriched ? (
            <VerifiedIcon className="size-[1em] shrink-0"
              aria-label={t("preview.actions.verified")} />
          ) : null}
        </div>
        ...
        <div className="flex items-center gap-[0.4em] text-[0.82em]">
          <MusicIcon className="size-[1em] shrink-0"
            aria-hidden />
          {enriched ? (
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-[0.6em] px-[1em] pt-[0.7em] pb-[1.4em]">
        ...
        <SendIcon className="size-[1.5em] shrink-0"
          aria-label={t("preview.actions.share")} />
      </div>
    </div>
  );
}
