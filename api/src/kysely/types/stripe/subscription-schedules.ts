...
export type SubscriptionSchedulesId = string & {
  __brand: 'stripe.subscription_schedules';
};

/** Represents the table stripe.subscription_schedules */
export default interface SubscriptionSchedulesTable {
  id: ColumnType<
    SubscriptionSchedulesId,
    SubscriptionSchedulesId,
    SubscriptionSchedulesId
  >;
  ...
  current_phase_start: ColumnType<
    Date | null,
    Date | string | null,
    Date | string | null
  >;

  current_phase_end: ColumnType<
    Date | null,
    Date | string | null,
    Date | string | null
  >;

  released_at: ColumnType<
    Date | null,
    Date | string | null,
    Date | string | null
  >;
  ...
  released_subscription_id: ColumnType<
    string | null,
    string | null,
    string | null
  >;
...
export type SubscriptionSchedulesUpdate =
  Updateable<SubscriptionSchedulesTable>;
