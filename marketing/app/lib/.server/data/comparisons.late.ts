...
export const late: CompetitorComparisonData = {
  ...
  youMightUse: {
    competitorScenarios: [
      "You require access to a social media platform that Post for Me doesn't support yet (Late — now Zernio — publishes to channels like WhatsApp, Telegram, Discord, Snapchat, and Google Business).",
