...
export type PostForMeIconProps = ComponentProps<"svg"> & {
  /**
   * "brand" (default) and "monochrome" render identically — the Post for Me
   * mark is single-color by design and inherits `currentColor`. The variant
   * prop exists for API consistency across brand marks.
   */
  variant?: "brand" | "monochrome";
};

/** The Post for Me app mark (square). Single-color; sized via className. */
