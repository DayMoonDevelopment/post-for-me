...
export function AccountSelectorTrigger({
  ...
  return (
    <PopoverTrigger
      data-slot="account-selector-trigger"
      className={cn(
        "cn-control-radius flex h-9 w-64 items-center justify-between gap-2 border border-input bg-transparent px-3 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:opacity-50",
