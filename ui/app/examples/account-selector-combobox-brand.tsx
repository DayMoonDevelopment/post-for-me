 ...
 *
 * This variation shows the platform **brand mark at the trailing end** of each badge
 * (it rests as the brand and reveals the × on hover).
 */
export function AccountSelectorComboboxBrand() {
