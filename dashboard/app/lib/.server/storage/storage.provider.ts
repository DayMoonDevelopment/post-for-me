...
export interface IStorageProvider {
  upload(bucket: string, key: string, data: Buffer | Blob | File, options?: StorageUploadOptions): Promise<void>;
  uploadFromFilePath(bucket: string, key: string, filePath: string, contentType: string): Promise<void>;
